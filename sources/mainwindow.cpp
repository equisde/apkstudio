    ...
    : QMainWindow(parent)
{
    ...
    auto welcome = new QLabel("<h1 style='color: #555;'>APK Studio Pro</h1><p style='color: #777;'>Suelta un APK o XAPK para empezar la disección.</p>");
...
void MainWindow::handleActionApk() {
    QString path = QFileDialog::getOpenFileName(this, 
        tr("Seleccionar APK"), "", 
        "Android Files (*.apk *.xapk *.apks *.apkm);;All Files (*)");
...
void MainWindow::handleTabChanged(int index) { Q_UNUSED(index) }
...
void MainWindow::setupModernStyles() {
    setStyleSheet(R"(
        ...
        QTabBar::tab { background: #2d2d2d; color: #969696; padding: 10px 20px; border-right: 1px solid #1e1e1e; }
